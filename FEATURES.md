...
- Logische Entity-Type-Vorsortierung nach dem SUBJECT_FIRST-Prepass: alle `entity_types` des Projekts werden anhand der Prepass-Flags (Human/Animal/Environment/Objects, Hintergrund) gewichtet, offensichtliche Fehl-Passungen (z. B. Creature ohne Tiere im Bild) werden ausgeschlossen; die sortierte Kandidatenliste fließt in das Audit/JSON des KI-Runs ein.
